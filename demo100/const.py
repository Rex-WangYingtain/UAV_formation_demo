...
LR_ACTOR = 0.00001  # Actor的学习率     2000以前是0.0001，之后是0.00001
LR_CRITIC = 0.00001  # Critic的学习率   2000以前是0.0001，之后是0.00001
GAMMA = 0.95  # Discount Factor
MEMORY_SIZE = 102400000  # 经验回放缓存的容量
BATCH_SIZE = 1024  # Minibatch的大小
TAU = 0.005  # 软更新系数
